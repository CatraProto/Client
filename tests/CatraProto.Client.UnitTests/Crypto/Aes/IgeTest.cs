...
namespace CatraProto.Client.UnitTests.Crypto.Aes
{
	public class IgeTest
	{
		...
		[InlineData(
			...
			new byte[]
			{
				26, 133, 25, 166, 85, 123, 230, 82, 233, 218, 142, 67, 218, 78, 244, 69, 60, 244, 86, 180, 202, 72, 138, 163, 131, 199, 156, 152, 179,
				71, 151, 203
			}
		)]
		[InlineData(
			new byte[]
			{
				153, 112, 100, 135, 161, 205, 230, 19, 188, 109, 224, 182, 242, 75, 28, 122, 164, 72, 200, 185, 195, 64, 62, 52, 103, 168, 202, 216,
				147, 64, 245, 59
			},
			new byte[] { 84, 104, 105, 115, 32, 105, 115, 32, 97, 110, 32, 105, 109, 112, 108, 101 },
			new byte[]
			{
				109, 101, 110, 116, 97, 116, 105, 111, 110, 32, 111, 102, 32, 73, 71, 69, 32, 109, 111, 100, 101, 32, 102, 111, 114, 32, 79, 112, 101,
				110, 83, 83
			},
			new byte[]
			{
				76, 46, 32, 76, 101, 116, 39, 115, 32, 104, 111, 112, 101, 32, 66, 101, 110, 32, 103, 111, 116, 32, 105, 116, 32, 114, 105, 103, 104,
				116, 33, 10
			}
		)]
