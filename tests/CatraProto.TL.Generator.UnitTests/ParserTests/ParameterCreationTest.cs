...
namespace CatraProto.TL.Generator.UnitTests.ParserTests
{
    public class ParameterCreationTest
    {
        ...
        [Theory]
        [InlineData("test#123 parameterName:Bool = EtheriaType;", "ParameterName", false, false, typeof(Bool), true, "bool")]
        [InlineData("test#123 parameterName:true = EtheriaType;", "ParameterName", false, false, typeof(Bool), true, "bool")]
        [InlineData("test#123 parameterName:false = EtheriaType;", "ParameterName", false, false, typeof(Bool), true, "bool")]
        [InlineData("test#123 parameterName:flags.1?Bool = EtheriaType;", "ParameterName", false, false, typeof(Bool), true, "bool", 1)]
        [InlineData("test#123 parameterName:flags.1?true = EtheriaType;", "ParameterName", false, false, typeof(Bool), true, "bool", 1)]
        [InlineData("test#123 parameterName:flags.1?false = EtheriaType;", "ParameterName", false, false, typeof(Bool), true, "bool", 1)]
        [InlineData("test#123 parameterName:flags.1?Vector<Bool> = EtheriaType;", "ParameterName", false, true, typeof(Bool), true, "bool", 1)]
        [InlineData("test#123 parameterName:Vector<Bool> = EtheriaType;", "ParameterName", false, true, typeof(Bool), true, "bool")]
