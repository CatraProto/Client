...
namespace CatraProto.TL.Generator.UnitTests.ParserTests
{
	public class ParameterCreationTest
	{
		...
		[InlineData("test#123 parameterName:Pony = EtheriaType;", "ParameterName", false, false, typeof(GenericType), false, "PonyBase", null,
			DefaultNamespace)]
		[InlineData("test#123 parameterName:Vector<Pony> = EtheriaType;", "ParameterName", false, true, typeof(GenericType), false, "PonyBase", null,
			DefaultNamespace)]
		[InlineData("test#123 parameterName:flags.1?Pony = EtheriaType;", "ParameterName", false, false, typeof(GenericType), false, "PonyBase", 1,
			DefaultNamespace)]
		[InlineData("test#123 parameterName:flags.1?Vector<Pony> = EtheriaType;", "ParameterName", false, true, typeof(GenericType), false,
			"PonyBase", 1, DefaultNamespace)]
		...
		[InlineData("test#123 parameterName:flags.1?Vector<bytes> = EtheriaType;", "ParameterName", false, true, typeof(BytesType), true, "byte[]",
			1)]
		...
		[InlineData("test#123 parameterName:flags.1?Vector<double> = EtheriaType;", "ParameterName", false, true, typeof(DoubleType), true, "double",
			1)]
