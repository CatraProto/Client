...
namespace CatraProto.Client.TL.Schemas.MTProto
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1003222836; }
...
#nullable enable
        public override IObject? Clone()
        {
            ...
            newClonedObject.NewNonceHash1 = NewNonceHash1;
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not DhGenOk castedOther)
            {
                return true;
            }
            ...
            if (NewNonceHash1 != castedOther.NewNonceHash1)
            {
                return true;
            }
