...
namespace CatraProto.Client.TL.Schemas.MTProto
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -501201412; }
...
#nullable enable
        ...
        {
            var newClonedObject = new DestroySessionOk();
        ...
        {
            if (other is not DestroySessionOk castedOther)
            {
                return true;
            }
