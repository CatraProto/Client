...
namespace CatraProto.Client.TL.Schemas.CloudChats.Phone
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 475058500; }
...
#nullable enable
        ...
        {
            var newClonedObject = new LeaveGroupCallPresentation();
        ...
        {
            if (other is not LeaveGroupCallPresentation castedOther)
            {
                return true;
            }
