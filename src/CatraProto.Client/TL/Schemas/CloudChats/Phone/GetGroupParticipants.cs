...
namespace CatraProto.Client.TL.Schemas.CloudChats.Phone
{
    public partial class GetGroupParticipants : IMethod
    {
        ...
        [Newtonsoft.Json.JsonIgnore] System.Type IMethod.Type { get; init; } = typeof(CatraProto.Client.TL.Schemas.CloudChats.Phone.GroupParticipantsBase);
        ...
        [Newtonsoft.Json.JsonProperty("ids")] public IList<CatraProto.Client.TL.Schemas.CloudChats.InputPeerBase> Ids { get; set; }
