...
namespace CatraProto.Client.TL.Schemas.CloudChats.Phone
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1451287362; }
...
#nullable enable
        ...
        {
            var newClonedObject = new StartScheduledGroupCall();
        ...
        {
            if (other is not StartScheduledGroupCall castedOther)
            {
                return true;
            }
