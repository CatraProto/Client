...
{
    public class GlobalPrivacySettings : GlobalPrivacySettingsBase
    {
        [Flags]
        ...
        {
            Flags = ArchiveAndMuteNewNoncontactPeers == null
                ? FlagsHelper.UnsetFlag(Flags, 0)
                : FlagsHelper.SetFlag(Flags, 0);
        }
