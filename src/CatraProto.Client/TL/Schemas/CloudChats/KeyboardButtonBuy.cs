...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1344716869; }
...
#nullable enable
        ...
        {
            var newClonedObject = new KeyboardButtonBuy();
        ...
        {
            if (other is not KeyboardButtonBuy castedOther)
            {
                return true;
            }
