...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1090087980; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityStrike();
        ...
        {
            if (other is not MessageEntityStrike castedOther)
            {
                return true;
            }
