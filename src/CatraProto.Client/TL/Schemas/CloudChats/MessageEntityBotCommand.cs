...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1827637959; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityBotCommand();
        ...
        {
            if (other is not MessageEntityBotCommand castedOther)
            {
                return true;
            }
