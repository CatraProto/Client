...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1471006352; }
...
#nullable enable
        ...
        {
            var newClonedObject = new PhoneCallDiscardReasonHangup();
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not PhoneCallDiscardReasonHangup castedOther)
            {
                return true;
            }
