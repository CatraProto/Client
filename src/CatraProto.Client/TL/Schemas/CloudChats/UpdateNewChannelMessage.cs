...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1656358105; }
...
#nullable enable
        ...
        {
            var newClonedObject = new UpdateNewChannelMessage();
        ...
        {
            if (other is not UpdateNewChannelMessage castedOther)
            {
                return true;
            }
