...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    public partial class UpdateShortChatMessage : CatraProto.Client.TL.Schemas.CloudChats.UpdatesBase
    {
        ...
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1299050149; }
...
#nullable enable
        ...
        {
            if (other is not UpdateShortChatMessage castedOther)
            {
                return true;
            }
