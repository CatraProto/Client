...
namespace CatraProto.Client.TL.Schemas.CloudChats.Photos
{
    public partial class DeletePhotos : IMethod
    {
        ...
        [Newtonsoft.Json.JsonIgnore] System.Type IMethod.Type { get; init; } = typeof(long);

        [Newtonsoft.Json.JsonIgnore] bool IMethod.IsVector { get; init; } = true;

        [Newtonsoft.Json.JsonProperty("id")] public IList<CatraProto.Client.TL.Schemas.CloudChats.InputPhotoBase> Id { get; set; }
