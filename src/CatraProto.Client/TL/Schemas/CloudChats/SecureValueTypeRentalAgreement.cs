...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1954007928; }
...
#nullable enable
        ...
        {
            var newClonedObject = new SecureValueTypeRentalAgreement();
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not SecureValueTypeRentalAgreement castedOther)
            {
                return true;
            }
