...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1717268701; }
...
#nullable enable
        ...
        {
            var newClonedObject = new SecureValueTypeInternalPassport();
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not SecureValueTypeInternalPassport castedOther)
            {
                return true;
            }
