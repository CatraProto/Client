...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 34469328; }
...
#nullable disable
        internal MessageEntityBlockquote()
        {
        }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityBlockquote();
        ...
        {
            if (other is not MessageEntityBlockquote castedOther)
            {
                return true;
            }
