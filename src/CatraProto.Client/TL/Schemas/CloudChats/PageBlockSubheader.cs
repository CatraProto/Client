...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -248793375; }
...
#nullable enable
        ...
        {
            var newClonedObject = new PageBlockSubheader();
        ...
        {
            if (other is not PageBlockSubheader castedOther)
            {
                return true;
            }
