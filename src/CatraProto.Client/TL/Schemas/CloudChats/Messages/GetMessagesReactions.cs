...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    public partial class GetMessagesReactions : IMethod
    {
        ...
        public static int ConstructorId { get => -1950707482; }
...
#nullable enable
        public GetMessagesReactions(CatraProto.Client.TL.Schemas.CloudChats.InputPeerBase peer, List<int> id)
        {
            Peer = peer;
            Id = id;
...
#nullable enable
        ...
        {
            var newClonedObject = new GetMessagesReactions();
        ...
        {
            if (other is not GetMessagesReactions castedOther)
            {
                return true;
            }
