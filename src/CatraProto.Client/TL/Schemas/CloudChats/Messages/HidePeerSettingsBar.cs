...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1336717624; }
...
#nullable enable
        ...
        {
            var newClonedObject = new HidePeerSettingsBar();
        ...
        {
            if (other is not HidePeerSettingsBar castedOther)
            {
                return true;
            }
