...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1678738104; }
...
#nullable enable
        ...
        {
            var newClonedObject = new GetMaskStickers();
        ...
        {
            if (other is not GetMaskStickers castedOther)
            {
                return true;
            }
