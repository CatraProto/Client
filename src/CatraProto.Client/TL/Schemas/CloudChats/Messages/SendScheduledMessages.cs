...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1120369398; }
...
#nullable enable
        public SendScheduledMessages(CatraProto.Client.TL.Schemas.CloudChats.InputPeerBase peer, List<int> id)
        {
            Peer = peer;
            Id = id;
        }
#nullable disable
        ...
        internal SendScheduledMessages()
        {
        }
...
#nullable enable
        ...
        {
            var newClonedObject = new SendScheduledMessages();
        ...
        {
            if (other is not SendScheduledMessages castedOther)
            {
                return true;
            }
