...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1197432408; }
...
#nullable enable
        ...
        {
            var newClonedObject = new GetAllStickers();
        ...
        {
            if (other is not GetAllStickers castedOther)
            {
                return true;
            }
