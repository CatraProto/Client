...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1111817116; }
...
#nullable enable
        public GetScheduledMessages(CatraProto.Client.TL.Schemas.CloudChats.InputPeerBase peer, List<int> id)
        {
            Peer = peer;
            Id = id;
        }
...
#nullable enable
        ...
        {
            var newClonedObject = new GetScheduledMessages();
        ...
        {
            if (other is not GetScheduledMessages castedOther)
            {
                return true;
            }
