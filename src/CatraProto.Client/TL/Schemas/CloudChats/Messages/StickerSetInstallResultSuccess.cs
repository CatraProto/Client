...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 946083368; }
...
#nullable enable
        ...
        {
            var newClonedObject = new StickerSetInstallResultSuccess();
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not StickerSetInstallResultSuccess castedOther)
            {
                return true;
            }
