...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1941660731; }
...
#nullable enable
        ...
        {
            var newClonedObject = new GetPollResults();
        ...
        {
            if (other is not GetPollResults castedOther)
            {
                return true;
            }
