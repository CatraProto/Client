...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    public partial class DiscussionMessage : DiscussionMessageBase
    {
        ...
        [JsonProperty("max_id")] public override int? MaxId { get; set; }

        [JsonProperty("read_inbox_max_id")] public override int? ReadInboxMaxId { get; set; }

        [JsonProperty("read_outbox_max_id")] public override int? ReadOutboxMaxId { get; set; }
