...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    public partial class BotCallbackAnswer : BotCallbackAnswerBase
    {
        ...
        [JsonProperty("alert")] public override bool Alert { get; set; }

        [JsonProperty("has_url")] public override bool HasUrl { get; set; }

        [JsonProperty("native_ui")] public override bool NativeUi { get; set; }

        [JsonProperty("message")] public override string Message { get; set; }

        [JsonProperty("url")] public override string Url { get; set; }
