...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    public partial class DeleteMessages : IMethod
    {
        ...
        [Newtonsoft.Json.JsonIgnore] System.Type IMethod.Type { get; init; } = typeof(CatraProto.Client.TL.Schemas.CloudChats.Messages.AffectedMessagesBase);
    ...
    #nullable enable
        public DeleteMessages(IList<int> id)
        {
            Id = id;
        }
    #nullable disable
