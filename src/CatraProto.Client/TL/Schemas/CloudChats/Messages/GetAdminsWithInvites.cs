...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 958457583; }
...
#nullable enable
        ...
        {
            var newClonedObject = new GetAdminsWithInvites();
        ...
        {
            if (other is not GetAdminsWithInvites castedOther)
            {
                return true;
            }
