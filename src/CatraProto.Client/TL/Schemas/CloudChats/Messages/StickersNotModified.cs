...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -244016606; }
...
#nullable enable
        ...
        {
            var newClonedObject = new StickersNotModified();
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not StickersNotModified castedOther)
            {
                return true;
            }
