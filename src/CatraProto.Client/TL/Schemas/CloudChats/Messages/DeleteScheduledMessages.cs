...
namespace CatraProto.Client.TL.Schemas.CloudChats.Messages
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1504586518; }
...
#nullable enable
        public DeleteScheduledMessages(CatraProto.Client.TL.Schemas.CloudChats.InputPeerBase peer, List<int> id)
        {
            Peer = peer;
            Id = id;
        }
...
#nullable enable
        ...
        {
            var newClonedObject = new DeleteScheduledMessages();
        ...
        {
            if (other is not DeleteScheduledMessages castedOther)
            {
                return true;
            }
