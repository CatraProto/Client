...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1757493555; }
...
#nullable enable
        ...
        {
            var newClonedObject = new UpdateReadMessagesContents();
        ...
        {
            if (other is not UpdateReadMessagesContents castedOther)
            {
                return true;
            }
