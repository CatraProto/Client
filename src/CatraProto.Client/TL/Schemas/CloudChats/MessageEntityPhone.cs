...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1687559349; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityPhone();
        ...
        {
            if (other is not MessageEntityPhone castedOther)
            {
                return true;
            }
