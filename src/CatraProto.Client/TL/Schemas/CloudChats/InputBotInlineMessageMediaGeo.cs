...
{
    public class InputBotInlineMessageMediaGeo : InputBotInlineMessageBase
    {
        [Flags]
        ...
        public override void UpdateFlags()
        {
            ...
            Flags = ProximityNotificationRadius == null
                ? FlagsHelper.UnsetFlag(Flags, 3)
                : FlagsHelper.SetFlag(Flags, 3);
