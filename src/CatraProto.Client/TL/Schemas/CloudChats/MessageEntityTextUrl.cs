...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1990644519; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityTextUrl();
        ...
        {
            if (other is not MessageEntityTextUrl castedOther)
            {
                return true;
            }
