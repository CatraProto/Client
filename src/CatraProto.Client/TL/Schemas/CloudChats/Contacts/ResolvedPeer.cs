...
#nullable enable
        public ResolvedPeer(CatraProto.Client.TL.Schemas.CloudChats.PeerBase peer, List<CatraProto.Client.TL.Schemas.CloudChats.ChatBase> chats, List<CatraProto.Client.TL.Schemas.CloudChats.UserBase> users)
        {
            Peer = peer;
            Chats = chats;
            Users = users;
...
#nullable enable
        ...
        {
            var newClonedObject = new ResolvedPeer();
        ...
        {
            if (other is not ResolvedPeer castedOther)
            {
                return true;
            }
