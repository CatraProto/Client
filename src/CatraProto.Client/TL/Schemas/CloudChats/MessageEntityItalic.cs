...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -2106619040; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityItalic();
        ...
        {
            if (other is not MessageEntityItalic castedOther)
            {
                return true;
            }
