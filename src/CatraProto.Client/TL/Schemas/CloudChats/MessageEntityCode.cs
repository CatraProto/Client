...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 681706865; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityCode();
        ...
        {
            if (other is not MessageEntityCode castedOther)
            {
                return true;
            }
