...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1890305021; }
...
#nullable enable
        ...
        {
            var newClonedObject = new PageBlockTitle();
        ...
        {
            if (other is not PageBlockTitle castedOther)
            {
                return true;
            }
