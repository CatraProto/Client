...
namespace CatraProto.Client.TL.Schemas.CloudChats.Account
{
    public partial class InitTakeoutSession : IMethod
    {
        ...
        [JsonIgnore] Type IMethod.Type { get; init; } = typeof(TakeoutBase);

        [JsonIgnore] bool IMethod.IsVector { get; init; } = false;

        [JsonIgnore] public int Flags { get; set; }

        [JsonProperty("contacts")] public bool Contacts { get; set; }

        [JsonProperty("message_users")] public bool MessageUsers { get; set; }

        [JsonProperty("message_chats")] public bool MessageChats { get; set; }

        [JsonProperty("message_megagroups")] public bool MessageMegagroups { get; set; }

        [JsonProperty("message_channels")] public bool MessageChannels { get; set; }

        [JsonProperty("files")] public bool Files { get; set; }

        [JsonProperty("file_max_size")] public int? FileMaxSize { get; set; }
