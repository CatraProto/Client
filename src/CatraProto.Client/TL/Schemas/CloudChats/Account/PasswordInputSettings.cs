...
namespace CatraProto.Client.TL.Schemas.CloudChats.Account
{
    public partial class PasswordInputSettings : PasswordInputSettingsBase
    {
        ...
        [JsonProperty("new_password_hash")] public override byte[] NewPasswordHash { get; set; }

        [JsonProperty("hint")] public override string Hint { get; set; }

        [JsonProperty("email")] public override string Email { get; set; }

        [JsonProperty("new_secure_settings")] public override SecureSecretSettingsBase NewSecureSettings { get; set; }
