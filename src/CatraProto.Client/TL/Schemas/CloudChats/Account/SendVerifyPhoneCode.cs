...
namespace CatraProto.Client.TL.Schemas.CloudChats.Account
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1516022023; }
...
#nullable enable
        ...
        {
            var newClonedObject = new SendVerifyPhoneCode();
        ...
        {
            if (other is not SendVerifyPhoneCode castedOther)
            {
                return true;
            }
