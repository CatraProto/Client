...
namespace CatraProto.Client.TL.Schemas.CloudChats.Account
{
    public partial class ContentSettings : ContentSettingsBase
    {
        ...
        [JsonProperty("sensitive_enabled")] public override bool SensitiveEnabled { get; set; }

        [JsonProperty("sensitive_can_change")] public override bool SensitiveCanChange { get; set; }
