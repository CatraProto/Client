...
namespace CatraProto.Client.TL.Schemas.CloudChats.Account
{
    public partial class Password : PasswordBase
    {
        ...
        [JsonProperty("has_recovery")] public override bool HasRecovery { get; set; }

        [JsonProperty("has_secure_values")] public override bool HasSecureValues { get; set; }

        [JsonProperty("has_password")] public override bool HasPassword { get; set; }

        [JsonProperty("current_algo")] public override PasswordKdfAlgoBase CurrentAlgo { get; set; }

        [JsonProperty("srp_B")] public override byte[] SrpB { get; set; }

        [JsonProperty("srp_id")] public override long? SrpId { get; set; }

        [JsonProperty("hint")] public override string Hint { get; set; }

        [JsonProperty("email_unconfirmed_pattern")]
        public override string EmailUnconfirmedPattern { get; set; }

        [JsonProperty("new_algo")] public override PasswordKdfAlgoBase NewAlgo { get; set; }

        [JsonProperty("new_secure_algo")] public override SecurePasswordKdfAlgoBase NewSecureAlgo { get; set; }

        [JsonProperty("secure_random")] public override byte[] SecureRandom { get; set; }
