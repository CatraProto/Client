...
namespace CatraProto.Client.TL.Schemas.CloudChats.Account
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 127302966; }
...
#nullable enable
        ...
        {
            var newClonedObject = new GetWallPapers();
        ...
        {
            if (other is not GetWallPapers castedOther)
            {
                return true;
            }
