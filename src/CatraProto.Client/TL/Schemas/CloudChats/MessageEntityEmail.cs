...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1692693954; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityEmail();
        ...
        {
            if (other is not MessageEntityEmail castedOther)
            {
                return true;
            }
