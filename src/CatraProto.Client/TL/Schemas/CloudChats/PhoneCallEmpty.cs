...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1399245077; }
...
#nullable enable
        ...
        {
            var newClonedObject = new PhoneCallEmpty();
        ...
        {
            if (other is not PhoneCallEmpty castedOther)
            {
                return true;
            }
