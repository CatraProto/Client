...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 4883767; }
...
#nullable enable
        ...
        {
            var newClonedObject = new SecurePasswordKdfAlgoUnknown();
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not SecurePasswordKdfAlgoUnknown castedOther)
            {
                return true;
            }
