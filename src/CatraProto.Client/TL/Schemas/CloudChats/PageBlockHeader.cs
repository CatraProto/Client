...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1076861716; }
...
#nullable enable
        ...
        {
            var newClonedObject = new PageBlockHeader();
        ...
        {
            if (other is not PageBlockHeader castedOther)
            {
                return true;
            }
