...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1672577397; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityUnderline();
        ...
        {
            if (other is not MessageEntityUnderline castedOther)
            {
                return true;
            }
