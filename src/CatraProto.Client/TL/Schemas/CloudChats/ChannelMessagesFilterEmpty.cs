...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -1798033689; }
...
#nullable enable
        ...
        {
            var newClonedObject = new ChannelMessagesFilterEmpty();
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not ChannelMessagesFilterEmpty castedOther)
            {
                return true;
            }
