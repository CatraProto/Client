...
namespace CatraProto.Client.TL.Schemas.CloudChats.Bots
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1032708345; }
...
#nullable enable
        ...
        {
            var newClonedObject = new ResetBotCommands();
        ...
        {
            if (other is not ResetBotCommands castedOther)
            {
                return true;
            }
