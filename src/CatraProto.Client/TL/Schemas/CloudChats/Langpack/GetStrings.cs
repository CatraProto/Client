...
namespace CatraProto.Client.TL.Schemas.CloudChats.Langpack
{
    public partial class GetStrings : IMethod
    {
        ...
        [Newtonsoft.Json.JsonIgnore] System.Type IMethod.Type { get; init; } = typeof(CatraProto.Client.TL.Schemas.CloudChats.LangPackStringBase);
        ...
        [Newtonsoft.Json.JsonProperty("keys")] public IList<string> Keys { get; set; }
