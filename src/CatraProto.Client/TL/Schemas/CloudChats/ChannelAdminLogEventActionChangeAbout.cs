...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1427671598; }
...
#nullable enable
        ...
        {
            var newClonedObject = new ChannelAdminLogEventActionChangeAbout();
        ...
        {
            if (other is not ChannelAdminLogEventActionChangeAbout castedOther)
            {
                return true;
            }
