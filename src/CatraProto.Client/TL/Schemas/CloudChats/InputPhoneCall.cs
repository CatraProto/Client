...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 506920429; }
...
#nullable enable
        ...
        {
            var newClonedObject = new InputPhoneCall();
        ...
        {
            if (other is not InputPhoneCall castedOther)
            {
                return true;
            }
