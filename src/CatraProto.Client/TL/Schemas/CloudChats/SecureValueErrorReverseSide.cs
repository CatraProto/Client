...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -2037765467; }
...
#nullable enable
        public SecureValueErrorReverseSide(CatraProto.Client.TL.Schemas.CloudChats.SecureValueTypeBase type, byte[] fileHash, string text)
        {
            Type = type;
            FileHash = fileHash;
            Text = text;
...
#nullable disable
        internal SecureValueErrorReverseSide()
        {
        }
...
#nullable enable
        ...
        {
            var newClonedObject = new SecureValueErrorReverseSide();
        ...
        {
            if (other is not SecureValueErrorReverseSide castedOther)
            {
                return true;
            }
