...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1121994683; }
...
#nullable enable
        ...
        {
            var newClonedObject = new ChannelAdminLogEventActionDeleteMessage();
        ...
        {
            if (other is not ChannelAdminLogEventActionDeleteMessage castedOther)
            {
                return true;
            }
