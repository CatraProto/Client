...
namespace CatraProto.Client.TL.Schemas.CloudChats.Help
{
    public partial class PromoData : PromoDataBase
    {
        ...
        [JsonProperty("peer")] public PeerBase Peer { get; set; }

        [JsonProperty("chats")] public IList<ChatBase> Chats { get; set; }

        [JsonProperty("users")] public IList<UserBase> Users { get; set; }

        [JsonProperty("psa_type")] public string PsaType { get; set; }

        [JsonProperty("psa_message")] public string PsaMessage { get; set; }
