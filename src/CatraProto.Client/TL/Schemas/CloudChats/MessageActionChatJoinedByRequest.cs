...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -339958837; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageActionChatJoinedByRequest();
            return newClonedObject;
        }

        public override bool Compare(IObject other)
        {
            if (other is not MessageActionChatJoinedByRequest castedOther)
            {
                return true;
            }
