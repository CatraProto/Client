...
namespace CatraProto.Client.TL.Schemas.CloudChats.Channels
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 187239529; }
...
#nullable enable
        ...
        {
            var newClonedObject = new ConvertToGigagroup();
        ...
        {
            if (other is not ConvertToGigagroup castedOther)
            {
                return true;
            }
