...
namespace CatraProto.Client.TL.Schemas.CloudChats.Channels
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -333377601; }
...
#nullable enable
        ...
        {
            var newClonedObject = new GetSponsoredMessages();
        ...
        {
            if (other is not GetSponsoredMessages castedOther)
            {
                return true;
            }
