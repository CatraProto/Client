...
{
    public partial class ToggleJoinRequest : IMethod
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1277789622; }
...
#nullable enable
        public ToggleJoinRequest(CatraProto.Client.TL.Schemas.CloudChats.InputChannelBase channel, bool enabled)
        {
            Channel = channel;
            Enabled = enabled;
        }
...
#nullable enable
        ...
        {
            var newClonedObject = new ToggleJoinRequest();
        ...
        {
            if (other is not ToggleJoinRequest castedOther)
            {
                return true;
            }
