...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 522914557; }
...
#nullable enable
        ...
        {
            var newClonedObject = new UpdateNewMessage();
        ...
        {
            if (other is not UpdateNewMessage castedOther)
            {
                return true;
            }
