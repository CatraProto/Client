...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => -100378723; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityMention();
        ...
        {
            if (other is not MessageEntityMention castedOther)
            {
                return true;
            }
