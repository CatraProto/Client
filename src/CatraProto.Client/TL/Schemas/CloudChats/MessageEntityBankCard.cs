...
{
    public partial class MessageEntityBankCard : CatraProto.Client.TL.Schemas.CloudChats.MessageEntityBase
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1981704948; }
...
#nullable disable
        internal MessageEntityBankCard()
        {
        }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityBankCard();
        ...
        {
            if (other is not MessageEntityBankCard castedOther)
            {
                return true;
            }
