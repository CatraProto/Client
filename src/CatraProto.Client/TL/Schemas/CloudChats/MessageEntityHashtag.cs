...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    ...
    {
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1868782349; }
...
#nullable enable
        ...
        {
            var newClonedObject = new MessageEntityHashtag();
        ...
        {
            if (other is not MessageEntityHashtag castedOther)
            {
                return true;
            }
