...
namespace CatraProto.Client.TL.Schemas.CloudChats
{
    public partial class InputBotInlineMessageText : CatraProto.Client.TL.Schemas.CloudChats.InputBotInlineMessageBase
    {
        ...
        [Newtonsoft.Json.JsonIgnore] public static int ConstructorId { get => 1036876423; }
...
#nullable enable
        ...
        {
            var newClonedObject = new InputBotInlineMessageText();
        ...
        {
            if (other is not InputBotInlineMessageText castedOther)
            {
                return true;
            }
