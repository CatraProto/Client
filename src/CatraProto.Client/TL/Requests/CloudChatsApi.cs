...
namespace CatraProto.Client.TL.Requests
{
    public partial class CloudChatsApi
    {
        ...
        public CloudChats.Updates Updates { get; }
        ...
        internal CloudChatsApi(MessagesQueue messagesQueue)
        {
            ...
            Updates = new CloudChats.Updates(messagesQueue);
        ...
        public async Task<RpcMessage<IObject>> InvokeAfterMsgAsync(long msgId, IObject query, MessageSendingOptions? messageSendingOptions = null,
        ...
        public async Task<RpcMessage<IObject>> InvokeAfterMsgsAsync(IList<long> msgIds, IObject query,
        ...
        public async Task<RpcMessage<IObject>> InitConnectionAsync(int apiId, string deviceModel, string systemVersion, string appVersion,
            string systemLangCode, string langPack, string langCode, IObject query, InputClientProxyBase? proxy = null, JSONValueBase? pparams = null,
            MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<IObject>(
            );
        ...
        public async Task<RpcMessage<IObject>> InvokeWithLayerAsync(int layer, IObject query, MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<IObject>(
            );
        ...
        public async Task<RpcMessage<IObject>> InvokeWithoutUpdatesAsync(IObject query, MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<IObject>(
            );
