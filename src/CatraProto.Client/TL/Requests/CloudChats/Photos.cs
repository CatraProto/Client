...
namespace CatraProto.Client.TL.Requests.CloudChats
{
    public partial class Photos
    {
        ...
        public async Task<RpcMessage<PhotoBase>> UpdateProfilePhotoAsync(InputPhotoBase id, MessageSendingOptions? messageSendingOptions = null,
        ...
        public async Task<RpcMessage<PhotoBase>> UploadProfilePhotoAsync(InputFileBase? file = null, InputFileBase? video = null,
            double? videoStartTs = null, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<PhotoBase>(
            );
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<RpcVector<long>>> DeletePhotosAsync(IList<InputPhotoBase> id,
