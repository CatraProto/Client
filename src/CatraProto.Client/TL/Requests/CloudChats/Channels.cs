...
namespace CatraProto.Client.TL.Requests.CloudChats
{
	public partial class Channels
	{
		...
		public async Task<RpcMessage<bool>> ReadHistoryAsync(InputChannelBase channel, int maxId, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
		...
		public async Task<RpcMessage<AffectedHistoryBase>> DeleteUserHistoryAsync(InputChannelBase channel, InputUserBase userId,
			CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
		...
		public async Task<RpcMessage<bool>> ReportSpamAsync(InputChannelBase channel, InputUserBase userId, List<int> id,
			CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
		...
		public async Task<RpcMessage<MessagesBase>> GetMessagesAsync(InputChannelBase channel, List<InputMessageBase> id,
			CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
		...
		public async Task<RpcMessage<ChannelParticipantsBase>> GetParticipantsAsync(InputChannelBase channel, ChannelParticipantsFilterBase filter,
			int offset, int limit, int hash, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<ChannelParticipantBase>> GetParticipantAsync(InputChannelBase channel, InputUserBase userId,
			CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
		...
		public async Task<RpcMessage<ChatsBase>> GetChannelsAsync(List<InputChannelBase> id, CancellationToken cancellationToken = default)
		{
			if (id is null)
			{
				throw new ArgumentNullException(nameof(id));
		...
		public async Task<RpcMessage<ChatFullBase>> GetFullChannelAsync(InputChannelBase channel, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<UpdatesBase>> CreateChannelAsync(string title, string about, bool broadcast = true, bool megagroup = true,
			bool forImport = true, InputGeoPointBase geoPoint = null, string address = null, CancellationToken cancellationToken = default)
		{
			if (title is null)
			{
		...
		public async Task<RpcMessage<UpdatesBase>> EditAdminAsync(InputChannelBase channel, InputUserBase userId, ChatAdminRightsBase adminRights,
			string rank, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<UpdatesBase>> JoinChannelAsync(InputChannelBase channel, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<UpdatesBase>> LeaveChannelAsync(InputChannelBase channel, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<UpdatesBase>> InviteToChannelAsync(InputChannelBase channel, List<InputUserBase> users,
			CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
		...
		public async Task<RpcMessage<UpdatesBase>> DeleteChannelAsync(InputChannelBase channel, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<ExportedMessageLinkBase>> ExportMessageLinkAsync(InputChannelBase channel, int id, bool grouped = true,
			bool thread = true, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<ChatsBase>> GetAdminedPublicChannelsAsync(bool byLocation = true, bool checkLimit = true,
			CancellationToken cancellationToken = default)
		{
			var rpcResponse = new RpcMessage<ChatsBase>();
		...
		public async Task<RpcMessage<UpdatesBase>> EditBannedAsync(InputChannelBase channel, InputUserBase userId, ChatBannedRightsBase bannedRights,
			CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
		...
		public async Task<RpcMessage<AdminLogResultsBase>> GetAdminLogAsync(InputChannelBase channel, string q, long maxId, long minId, int limit,
			ChannelAdminLogEventsFilterBase eventsFilter = null, List<InputUserBase> admins = null, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<bool>> DeleteHistoryAsync(InputChannelBase channel, int maxId, CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
				throw new ArgumentNullException(nameof(channel));
		...
		public async Task<RpcMessage<ChatsBase>> GetLeftChannelsAsync(int offset, CancellationToken cancellationToken = default)
		{
			var rpcResponse = new RpcMessage<ChatsBase>();
		...
		public async Task<RpcMessage<ChatsBase>> GetGroupsForDiscussionAsync(CancellationToken cancellationToken = default)
		{
			var rpcResponse = new RpcMessage<ChatsBase>();
		...
		public async Task<RpcMessage<bool>> EditLocationAsync(InputChannelBase channel, InputGeoPointBase geoPoint, string address,
			CancellationToken cancellationToken = default)
		{
			if (channel is null)
			{
		...
		public async Task<RpcMessage<InactiveChatsBase>> GetInactiveChannelsAsync(CancellationToken cancellationToken = default)
		{
