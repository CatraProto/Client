...
if(langCode is null) throw new ArgumentNullException(nameof(langCode));
		...
		public async Task<RpcMessage<CatraProto.Client.TL.Schemas.CloudChats.LangPackStringBase>> GetStringsAsync(string langPack, string langCode, List<string> keys, CancellationToken cancellationToken = default)
		{
			if(langPack is null) throw new ArgumentNullException(nameof(langPack));
if(langCode is null) throw new ArgumentNullException(nameof(langCode));
...
if(langCode is null) throw new ArgumentNullException(nameof(langCode));
		...
		public async Task<RpcMessage<CatraProto.Client.TL.Schemas.CloudChats.LangPackLanguageBase>> GetLanguagesAsync(string langPack, CancellationToken cancellationToken = default)
		{
			if(langPack is null) throw new ArgumentNullException(nameof(langPack));
