...
namespace CatraProto.Client.TL.Requests.CloudChats
{
    public partial class Langpack
    {
        ...
        {
            var rpcResponse = new RpcMessage<RpcVector<LangPackStringBase>>(new RpcVector<LangPackStringBase>());
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        {
            var rpcResponse = new RpcMessage<RpcVector<LangPackLanguageBase>>(new RpcVector<LangPackLanguageBase>());
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
