...
namespace CatraProto.Client.TL.Requests.CloudChats
{
    public class Messages
    {
        ...
        public async Task<RpcMessage<MessagesBase>> GetMessagesAsync(List<InputMessageBase> id,
        ...
        public async Task<RpcMessage<DialogsBase>> GetDialogsAsync(int offsetDate, int offsetId,
            InputPeerBase offsetPeer, int limit, int hash, bool excludePinned = true, int? folderId = null,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<MessagesBase>> GetHistoryAsync(InputPeerBase peer, int offsetId, int offsetDate,
            int addOffset, int limit, int maxId, int minId, int hash, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<MessagesBase>> SearchAsync(InputPeerBase peer, string q, MessagesFilterBase filter,
            int minDate, int maxDate, int offsetId, int addOffset, int limit, int maxId, int minId, int hash,
            InputPeerBase fromId = null, int? topMsgId = null, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<AffectedHistoryBase>> DeleteHistoryAsync(InputPeerBase peer, int maxId,
            bool justClear = true, bool revoke = true, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<ReceivedNotifyMessageBase>> ReceivedMessagesAsync(int maxId,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> SetTypingAsync(InputPeerBase peer, SendMessageActionBase action,
            int? topMsgId = null, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<UpdatesBase>> SendMessageAsync(InputPeerBase peer, string message, long randomId,
            bool noWebpage = true, bool silent = true, bool background = true, bool clearDraft = true,
            int? replyToMsgId = null, ReplyMarkupBase replyMarkup = null, List<MessageEntityBase> entities = null,
        ...
        public async Task<RpcMessage<UpdatesBase>> SendMediaAsync(InputPeerBase peer, InputMediaBase media,
            string message, long randomId, bool silent = true, bool background = true, bool clearDraft = true,
            int? replyToMsgId = null, ReplyMarkupBase replyMarkup = null, List<MessageEntityBase> entities = null,
            int? scheduleDate = null, CancellationToken cancellationToken = default)
        {
            if (peer is null)
        ...
        public async Task<RpcMessage<UpdatesBase>> ForwardMessagesAsync(InputPeerBase fromPeer, List<int> id,
            List<long> randomId, InputPeerBase toPeer, bool silent = true, bool background = true,
            bool withMyScore = true, int? scheduleDate = null, CancellationToken cancellationToken = default)
        {
            if (fromPeer is null)
            {
        ...
        public async Task<RpcMessage<bool>> ReportSpamAsync(InputPeerBase peer,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<PeerSettingsBase>> GetPeerSettingsAsync(InputPeerBase peer,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<ChatsBase>> GetChatsAsync(List<int> id,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<ChatFullBase>> GetFullChatAsync(int chatId,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<UpdatesBase>> EditChatTitleAsync(int chatId, string title,
            CancellationToken cancellationToken = default)
        {
            if (title is null)
            {
        ...
        public async Task<RpcMessage<DhConfigBase>> GetDhConfigAsync(int version, int randomLength,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<EncryptedChatBase>> RequestEncryptionAsync(InputUserBase userId, int randomId,
            byte[] gA, CancellationToken cancellationToken = default)
        {
            if (userId is null)
            {
                throw new ArgumentNullException(nameof(userId));
        ...
        public async Task<RpcMessage<EncryptedChatBase>> AcceptEncryptionAsync(InputEncryptedChatBase peer, byte[] gB,
            long keyFingerprint, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<bool>> DiscardEncryptionAsync(int chatId,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
        ...
        public async Task<RpcMessage<SentEncryptedMessageBase>> SendEncryptedAsync(InputEncryptedChatBase peer,
            long randomId, byte[] data, bool silent = true, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<SentEncryptedMessageBase>> SendEncryptedFileAsync(InputEncryptedChatBase peer,
            long randomId, byte[] data, InputEncryptedFileBase file, bool silent = true,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<SentEncryptedMessageBase>> SendEncryptedServiceAsync(InputEncryptedChatBase peer,
            long randomId, byte[] data, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<long>> ReceivedQueueAsync(int maxQts,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> ReportEncryptedSpamAsync(InputEncryptedChatBase peer,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<AffectedMessagesBase>> ReadMessageContentsAsync(List<int> id,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<AffectedMessagesBase>();
        ...
        public async Task<RpcMessage<StickersBase>> GetStickersAsync(string emoticon, int hash,
            CancellationToken cancellationToken = default)
        {
            if (emoticon is null)
            {
        ...
        public async Task<RpcMessage<AllStickersBase>> GetAllStickersAsync(int hash,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<MessageMediaBase>> GetWebPagePreviewAsync(string message,
        ...
        public async Task<RpcMessage<ExportedChatInviteBase>> ExportChatInviteAsync(InputPeerBase peer,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<ChatInviteBase>> CheckChatInviteAsync(string hash,
            CancellationToken cancellationToken = default)
        {
            if (hash is null)
            {
        ...
        public async Task<RpcMessage<UpdatesBase>> ImportChatInviteAsync(string hash,
            CancellationToken cancellationToken = default)
        {
            if (hash is null)
            {
        ...
        public async Task<RpcMessage<StickerSetInstallResultBase>> InstallStickerSetAsync(
            InputStickerSetBase stickerset, bool archived, CancellationToken cancellationToken = default)
        {
            if (stickerset is null)
            {
                throw new ArgumentNullException(nameof(stickerset));
        ...
        public async Task<RpcMessage<bool>> UninstallStickerSetAsync(InputStickerSetBase stickerset,
            CancellationToken cancellationToken = default)
        {
            if (stickerset is null)
            {
        ...
        public async Task<RpcMessage<UpdatesBase>> StartBotAsync(InputUserBase bot, InputPeerBase peer, long randomId,
            string startParam, CancellationToken cancellationToken = default)
        {
            if (bot is null)
            {
        ...
        public async Task<RpcMessage<MessageViewsBase>> GetMessagesViewsAsync(InputPeerBase peer, List<int> id,
            bool increment, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<UpdatesBase>> MigrateChatAsync(int chatId,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<UpdatesBase>();
        ...
        public async Task<RpcMessage<MessagesBase>> SearchGlobalAsync(string q, MessagesFilterBase filter, int minDate,
            int maxDate, int offsetRate, InputPeerBase offsetPeer, int offsetId, int limit, int? folderId = null,
            CancellationToken cancellationToken = default)
        {
            if (q is null)
            {
        ...
        public async Task<RpcMessage<SavedGifsBase>> GetSavedGifsAsync(int hash,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> SaveGifAsync(InputDocumentBase id, bool unsave,
            CancellationToken cancellationToken = default)
        {
            if (id is null)
            {
        ...
        public async Task<RpcMessage<BotResultsBase>> GetInlineBotResultsAsync(InputUserBase bot, InputPeerBase peer,
            string query, string offset, InputGeoPointBase geoPoint = null,
            CancellationToken cancellationToken = default)
        {
            if (bot is null)
            {
        ...
        public async Task<RpcMessage<bool>> SetInlineBotResultsAsync(long queryId,
            List<InputBotInlineResultBase> results, int cacheTime, bool gallery = true, bool pprivate = true,
            string nextOffset = null, InlineBotSwitchPMBase switchPm = null,
            CancellationToken cancellationToken = default)
        {
            if (results is null)
            {
        ...
        public async Task<RpcMessage<UpdatesBase>> SendInlineBotResultAsync(InputPeerBase peer, long randomId,
            long queryId, string id, bool silent = true, bool background = true, bool clearDraft = true,
            bool hideVia = true, int? replyToMsgId = null, int? scheduleDate = null,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<UpdatesBase>> EditMessageAsync(InputPeerBase peer, int id, bool noWebpage = true,
            string message = null, InputMediaBase media = null, ReplyMarkupBase replyMarkup = null,
            List<MessageEntityBase> entities = null, int? scheduleDate = null,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<bool>> EditInlineBotMessageAsync(InputBotInlineMessageIDBase id,
            bool noWebpage = true, string message = null, InputMediaBase media = null,
            ReplyMarkupBase replyMarkup = null, List<MessageEntityBase> entities = null,
            CancellationToken cancellationToken = default)
        {
            if (id is null)
            {
        ...
        public async Task<RpcMessage<BotCallbackAnswerBase>> GetBotCallbackAnswerAsync(InputPeerBase peer, int msgId,
            bool game = true, byte[] data = null, InputCheckPasswordSRPBase password = null,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<bool>> SetBotCallbackAnswerAsync(long queryId, int cacheTime, bool alert = true,
            string message = null, string url = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
        ...
        public async Task<RpcMessage<bool>> SaveDraftAsync(InputPeerBase peer, string message, bool noWebpage = true,
            int? replyToMsgId = null, List<MessageEntityBase> entities = null,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<FeaturedStickersBase>> GetFeaturedStickersAsync(int hash,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> ReadFeaturedStickersAsync(List<long> id,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
        ...
        public async Task<RpcMessage<bool>> SaveRecentStickerAsync(InputDocumentBase id, bool unsave,
            bool attached = true, CancellationToken cancellationToken = default)
        {
            if (id is null)
            {
                throw new ArgumentNullException(nameof(id));
        ...
        public async Task<RpcMessage<bool>> ClearRecentStickersAsync(bool attached = true,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
        ...
        public async Task<RpcMessage<ArchivedStickersBase>> GetArchivedStickersAsync(long offsetId, int limit,
            bool masks = true, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<AllStickersBase>> GetMaskStickersAsync(int hash,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<AllStickersBase>();
        ...
        public async Task<RpcMessage<UpdatesBase>> SetGameScoreAsync(InputPeerBase peer, int id, InputUserBase userId,
            int score, bool editMessage = true, bool force = true, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<bool>> SetInlineGameScoreAsync(InputBotInlineMessageIDBase id,
            InputUserBase userId, int score, bool editMessage = true, bool force = true,
            CancellationToken cancellationToken = default)
        {
            if (id is null)
            {
        ...
        public async Task<RpcMessage<HighScoresBase>> GetGameHighScoresAsync(InputPeerBase peer, int id,
        ...
        public async Task<RpcMessage<HighScoresBase>> GetInlineGameHighScoresAsync(InputBotInlineMessageIDBase id,
            InputUserBase userId, CancellationToken cancellationToken = default)
        {
            if (id is null)
            {
        ...
        public async Task<RpcMessage<ChatsBase>> GetAllChatsAsync(List<int> exceptIds,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<ChatsBase>();
        ...
        public async Task<RpcMessage<WebPageBase>> GetWebPageAsync(string url, int hash,
            CancellationToken cancellationToken = default)
        {
            if (url is null)
            {
        ...
        public async Task<RpcMessage<bool>> ReorderPinnedDialogsAsync(int folderId, List<InputDialogPeerBase> order,
            bool force = true, CancellationToken cancellationToken = default)
        {
            if (order is null)
            {
        ...
        public async Task<RpcMessage<PeerDialogsBase>> GetPinnedDialogsAsync(int folderId,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<PeerDialogsBase>();
        ...
        public async Task<RpcMessage<bool>> SetBotPrecheckoutResultsAsync(long queryId, bool success = true,
        ...
        public async Task<RpcMessage<UpdatesBase>> SendScreenshotNotificationAsync(InputPeerBase peer, int replyToMsgId,
            long randomId, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<FavedStickersBase>> GetFavedStickersAsync(int hash,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> FaveStickerAsync(InputDocumentBase id, bool unfave,
            CancellationToken cancellationToken = default)
        {
            if (id is null)
            {
        ...
        public async Task<RpcMessage<MessagesBase>> GetUnreadMentionsAsync(InputPeerBase peer, int offsetId,
            int addOffset, int limit, int maxId, int minId, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<AffectedHistoryBase>> ReadMentionsAsync(InputPeerBase peer,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<UpdatesBase>> SendMultiMediaAsync(InputPeerBase peer,
            List<InputSingleMediaBase> multiMedia, bool silent = true, bool background = true, bool clearDraft = true,
            int? replyToMsgId = null, int? scheduleDate = null, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<EncryptedFileBase>> UploadEncryptedFileAsync(InputEncryptedChatBase peer,
            InputEncryptedFileBase file, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<FoundStickerSetsBase>> SearchStickerSetsAsync(string q, int hash,
            bool excludeFeatured = true, CancellationToken cancellationToken = default)
        {
            if (q is null)
            {
                throw new ArgumentNullException(nameof(q));
        ...
        public async Task<RpcMessage<MessageRangeBase>> GetSplitRangesAsync(
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<DialogPeerBase>> GetDialogUnreadMarksAsync(
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<UpdatesBase>> UpdatePinnedMessageAsync(InputPeerBase peer, int id,
            bool silent = true, bool unpin = true, bool pmOneside = true, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<UpdatesBase>> GetPollResultsAsync(InputPeerBase peer, int msgId,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<ChatOnlinesBase>> GetOnlinesAsync(InputPeerBase peer,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<StatsURLBase>> GetStatsURLAsync(InputPeerBase peer, string pparams,
        ...
        public async Task<RpcMessage<bool>> EditChatAboutAsync(InputPeerBase peer, string about,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<UpdatesBase>> EditChatDefaultBannedRightsAsync(InputPeerBase peer,
        ...
        public async Task<RpcMessage<EmojiKeywordsDifferenceBase>> GetEmojiKeywordsDifferenceAsync(string langCode,
        ...
        public async Task<RpcMessage<EmojiURLBase>> GetEmojiURLAsync(string langCode,
            CancellationToken cancellationToken = default)
        {
            if (langCode is null)
            {
        ...
        public async Task<RpcMessage<SearchCounterBase>> GetSearchCountersAsync(InputPeerBase peer,
            List<MessagesFilterBase> filters, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<UrlAuthResultBase>> RequestUrlAuthAsync(InputPeerBase peer, int msgId,
            int buttonId, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<UrlAuthResultBase>> AcceptUrlAuthAsync(InputPeerBase peer, int msgId, int buttonId,
            bool writeAllowed = true, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<bool>> HidePeerSettingsBarAsync(InputPeerBase peer,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<VotesListBase>> GetPollVotesAsync(InputPeerBase peer, int id, int limit,
            byte[] option = null, string offset = null, CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
                throw new ArgumentNullException(nameof(peer));
        ...
        public async Task<RpcMessage<bool>> ToggleStickerSetsAsync(List<InputStickerSetBase> stickersets,
            bool uninstall = true, bool archive = true, bool unarchive = true,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<DialogFilterBase>> GetDialogFiltersAsync(
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<DialogFilterSuggestedBase>> GetSuggestedDialogFiltersAsync(
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> UpdateDialogFiltersOrderAsync(List<int> order,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
        ...
        public async Task<RpcMessage<MessagesBase>> GetRepliesAsync(InputPeerBase peer, int msgId, int offsetId,
            int offsetDate, int addOffset, int limit, int maxId, int minId, int hash,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
        ...
        public async Task<RpcMessage<AffectedHistoryBase>> UnpinAllMessagesAsync(InputPeerBase peer,
            CancellationToken cancellationToken = default)
        {
            if (peer is null)
            {
