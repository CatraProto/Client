...
namespace CatraProto.Client.TL.Requests.CloudChats
{
	public partial class Contacts
	{
		...
		public async Task<RpcMessage<ContactsBase>> GetContactsAsync(int hash, CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<UpdatesBase>> DeleteContactsAsync(List<InputUserBase> id, CancellationToken cancellationToken = default)
		{
			if (id is null)
			{
		...
		public async Task<RpcMessage<bool>> UnblockAsync(InputPeerBase id, CancellationToken cancellationToken = default)
		{
			if (id is null)
			{
				throw new ArgumentNullException(nameof(id));
		...
		public async Task<RpcMessage<BlockedBase>> GetBlockedAsync(int offset, int limit, CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<FoundBase>> SearchAsync(string q, int limit, CancellationToken cancellationToken = default)
		{
			if (q is null)
			{
		...
		public async Task<RpcMessage<ResolvedPeerBase>> ResolveUsernameAsync(string username, CancellationToken cancellationToken = default)
		{
			if (username is null)
			{
		...
		public async Task<RpcMessage<TopPeersBase>> GetTopPeersAsync(int offset, int limit, int hash, bool correspondents = true, bool botsPm = true,
			...
			bool channels = true, CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<UpdatesBase>> AddContactAsync(InputUserBase id, string firstName, string lastName, string phone,
			bool addPhonePrivacyException = true, CancellationToken cancellationToken = default)
		{
			if (id is null)
			{
				throw new ArgumentNullException(nameof(id));
		...
		public async Task<RpcMessage<UpdatesBase>> AcceptContactAsync(InputUserBase id, CancellationToken cancellationToken = default)
		{
			if (id is null)
			{
				throw new ArgumentNullException(nameof(id));
		...
		public async Task<RpcMessage<UpdatesBase>> BlockFromRepliesAsync(int msgId, bool deleteMessage = true, bool deleteHistory = true,
			bool reportSpam = true, CancellationToken cancellationToken = default)
		{
			var rpcResponse = new RpcMessage<UpdatesBase>();
