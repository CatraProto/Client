...
namespace CatraProto.Client.TL.Requests.CloudChats
{
	public partial class Phone
	{
		...
		public async Task<RpcMessage<PhoneCallBase>> ConfirmCallAsync(InputPhoneCallBase peer, byte[] gA, long keyFingerprint,
			PhoneCallProtocolBase protocol, CancellationToken cancellationToken = default)
		{
			if (peer is null)
			{
				throw new ArgumentNullException(nameof(peer));
		...
		public async Task<RpcMessage<bool>> ReceivedCallAsync(InputPhoneCallBase peer, CancellationToken cancellationToken = default)
		{
			if (peer is null)
			{
				throw new ArgumentNullException(nameof(peer));
		...
		public async Task<RpcMessage<UpdatesBase>> DiscardCallAsync(InputPhoneCallBase peer, int duration, PhoneCallDiscardReasonBase reason,
			long connectionId, bool video = true, CancellationToken cancellationToken = default)
		{
			if (peer is null)
			{
				throw new ArgumentNullException(nameof(peer));
