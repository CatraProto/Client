...
namespace CatraProto.Client.TL.Requests.CloudChats
{
    public partial class Phone
    {
        ...
        {
            var rpcResponse = new RpcMessage<CatraProto.Client.MTProto.Rpc.Vectors.RpcVector<int>>(new CatraProto.Client.MTProto.Rpc.Vectors.RpcVector<int>());
            messageSendingOptions ??= new CatraProto.Client.Connections.MessageScheduling.MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<CatraProto.Client.TL.Schemas.CloudChats.UpdatesBase>> CreateGroupCallAsync(CatraProto.Client.MTProto.PeerId peer, int randomId, string? title = null, int? scheduleDate = null, CatraProto.Client.Connections.MessageScheduling.MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
