...
namespace CatraProto.Client.TL.Requests.CloudChats
{
    public partial class Phone
    {
        ...
        public async Task<RpcMessage<DataJSONBase>> GetCallConfigAsync(MessageSendingOptions? messageSendingOptions = null,
        ...
        public async Task<RpcMessage<PhoneCallBase>> RequestCallAsync(InputUserBase userId, int randomId, byte[] gAHash,
            PhoneCallProtocolBase protocol, bool video = true, MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<PhoneCallBase>> ConfirmCallAsync(InputPhoneCallBase peer, byte[] gA, long keyFingerprint,
            PhoneCallProtocolBase protocol, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<PhoneCallBase>(
            );
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<bool>> ReceivedCallAsync(InputPhoneCallBase peer, MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<UpdatesBase>> DiscardCallAsync(InputPhoneCallBase peer, int duration, PhoneCallDiscardReasonBase reason,
            long connectionId, bool video = true, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<UpdatesBase>> SetCallRatingAsync(InputPhoneCallBase peer, int rating, string comment, bool userInitiative = true,
            MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<UpdatesBase>(
            );
