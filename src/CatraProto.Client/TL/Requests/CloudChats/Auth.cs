...
namespace CatraProto.Client.TL.Requests.CloudChats
{
    public partial class Auth
    {
        ...
        public async Task<RpcMessage<bool>> LogOutAsync(MessageSendingOptions? messageSendingOptions = null,
        ...
        public async Task<RpcMessage<bool>> ResetAuthorizationsAsync(MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>(
            );
        ...
        public async Task<RpcMessage<PasswordRecoveryBase>> RequestPasswordRecoveryAsync(MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<AuthorizationBase>> RecoverPasswordAsync(string code, MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<AuthorizationBase>(
            );
        ...
        public async Task<RpcMessage<bool>> DropTempAuthKeysAsync(IList<long> exceptAuthKeys, MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>(
            );
        ...
        public async Task<RpcMessage<LoginTokenBase>> ExportLoginTokenAsync(int apiId, string apiHash, IList<int> exceptIds,
            MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<LoginTokenBase>> ImportLoginTokenAsync(byte[] token, MessageSendingOptions? messageSendingOptions = null,
            CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<LoginTokenBase>(
            );
