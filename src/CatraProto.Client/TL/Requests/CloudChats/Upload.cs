...
namespace CatraProto.Client.TL.Requests.CloudChats
{
	public partial class Upload
	{
	    ...
	    public async Task<RpcMessage<bool>> SaveFilePartAsync(long fileId, int filePart, byte[] bytes, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
		{
...
return rpcResponse;
	    ...
	    public async Task<RpcMessage<bool>> SaveBigFilePartAsync(long fileId, int filePart, int fileTotalParts, byte[] bytes, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
		{
