...
namespace CatraProto.Client.TL.Requests.CloudChats
{
	public partial class Upload
	{
		...
		public async Task<RpcMessage<CatraProto.Client.TL.Schemas.CloudChats.FileHashBase>> ReuploadCdnFileAsync(byte[] fileToken, byte[] requestToken, CancellationToken cancellationToken = default)
		{
			if(fileToken is null) throw new ArgumentNullException(nameof(fileToken));
if(requestToken is null) throw new ArgumentNullException(nameof(requestToken));
		...
		public async Task<RpcMessage<CatraProto.Client.TL.Schemas.CloudChats.FileHashBase>> GetCdnFileHashesAsync(byte[] fileToken, int offset, CancellationToken cancellationToken = default)
		{
			if(fileToken is null) throw new ArgumentNullException(nameof(fileToken));
		...
		public async Task<RpcMessage<CatraProto.Client.TL.Schemas.CloudChats.FileHashBase>> GetFileHashesAsync(CatraProto.Client.TL.Schemas.CloudChats.InputFileLocationBase location, int offset, CancellationToken cancellationToken = default)
		{
			if(location is null) throw new ArgumentNullException(nameof(location));
