...
namespace CatraProto.Client.TL.Requests.CloudChats
{
	public partial class Account
	{
		...
		public async Task<RpcMessage<bool>> RegisterDeviceAsync(int tokenType, string token, bool appSandbox, byte[] secret, List<int> otherUids,
			bool noMuted = true, CancellationToken cancellationToken = default)
		{
			if (token is null)
			{
		...
		public async Task<RpcMessage<WallPapersBase>> GetWallPapersAsync(int hash, CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<UserBase>> UpdateUsernameAsync(string username, CancellationToken cancellationToken = default)
		{
			if (username is null)
			{
				throw new ArgumentNullException(nameof(username));
		...
		public async Task<RpcMessage<PrivacyRulesBase>> GetPrivacyAsync(InputPrivacyKeyBase key, CancellationToken cancellationToken = default)
		{
			if (key is null)
			{
		...
		public async Task<RpcMessage<PrivacyRulesBase>> SetPrivacyAsync(InputPrivacyKeyBase key, List<InputPrivacyRuleBase> rules,
			CancellationToken cancellationToken = default)
		{
			if (key is null)
			{
		...
		public async Task<RpcMessage<AccountDaysTTLBase>> GetAccountTTLAsync(CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<bool>> SetAccountTTLAsync(AccountDaysTTLBase ttl, CancellationToken cancellationToken = default)
		{
			if (ttl is null)
			{
		...
		public async Task<RpcMessage<AuthorizationsBase>> GetAuthorizationsAsync(CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<WebAuthorizationsBase>> GetWebAuthorizationsAsync(CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<SecureValueBase>> GetAllSecureValuesAsync(CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<bool>> DeleteSecureValueAsync(List<SecureValueTypeBase> types, CancellationToken cancellationToken = default)
		{
			if (types is null)
			{
				throw new ArgumentNullException(nameof(types));
		...
		public async Task<RpcMessage<bool>> AcceptAuthorizationAsync(int botId, string scope, string publicKey, List<SecureValueHashBase> valueHashes,
			SecureCredentialsEncryptedBase credentials, CancellationToken cancellationToken = default)
		{
			if (scope is null)
			{
				throw new ArgumentNullException(nameof(scope));
		...
		public async Task<RpcMessage<SentEmailCodeBase>> SendVerifyEmailCodeAsync(string email, CancellationToken cancellationToken = default)
		{
			if (email is null)
			{
		...
		public async Task<RpcMessage<WallPaperBase>> GetWallPaperAsync(InputWallPaperBase wallpaper, CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<AutoDownloadSettingsBase>> GetAutoDownloadSettingsAsync(CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<bool>> SaveAutoDownloadSettingsAsync(Schemas.CloudChats.AutoDownloadSettingsBase settings, bool low = true,
			bool high = true, CancellationToken cancellationToken = default)
		{
			if (settings is null)
			{
				throw new ArgumentNullException(nameof(settings));
		...
		public async Task<RpcMessage<DocumentBase>> UploadThemeAsync(InputFileBase file, string fileName, string mimeType, InputFileBase thumb = null,
			CancellationToken cancellationToken = default)
		{
			if (file is null)
			{
		...
		public async Task<RpcMessage<ThemeBase>> UpdateThemeAsync(string format, InputThemeBase theme, string slug = null, string title = null,
			InputDocumentBase document = null, InputThemeSettingsBase settings = null, CancellationToken cancellationToken = default)
		{
			if (format is null)
			{
		...
		public async Task<RpcMessage<bool>> SaveThemeAsync(InputThemeBase theme, bool unsave, CancellationToken cancellationToken = default)
		{
			if (theme is null)
			{
				throw new ArgumentNullException(nameof(theme));
		...
		public async Task<RpcMessage<ThemesBase>> GetThemesAsync(string format, int hash, CancellationToken cancellationToken = default)
		{
			if (format is null)
			{
				throw new ArgumentNullException(nameof(format));
		...
		public async Task<RpcMessage<ContentSettingsBase>> GetContentSettingsAsync(CancellationToken cancellationToken = default)
		{
		...
		public async Task<RpcMessage<GlobalPrivacySettingsBase>> GetGlobalPrivacySettingsAsync(CancellationToken cancellationToken = default)
		{
