...
namespace CatraProto.Client.TL.Requests.CloudChats
{
    public partial class Account
    {
        ...
        public async Task<RpcMessage<bool>> RegisterDeviceAsync(int tokenType, string token, bool appSandbox, byte[] secret, IList<long> otherUids, bool noMuted = true, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> UnregisterDeviceAsync(int tokenType, string token, IList<long> otherUids, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<WallPapersBase>> GetWallPapersAsync(long hash, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> ReportPeerAsync(InputPeerBase peer, ReportReasonBase reason, string message, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        {
            var rpcResponse = new RpcMessage<RpcVector<SecureValueBase>>(new RpcVector<SecureValueBase>());
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<AuthorizationFormBase>> GetAuthorizationFormAsync(long botId, string scope, string publicKey, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> AcceptAuthorizationAsync(long botId, string scope, string publicKey, IList<SecureValueHashBase> valueHashes, SecureCredentialsEncryptedBase credentials, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<ThemeBase>> CreateThemeAsync(string slug, string title, InputDocumentBase? document = null, IList<InputThemeSettingsBase>? settings = null, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<ThemeBase>> UpdateThemeAsync(string format, InputThemeBase theme, string? slug = null, string? title = null, InputDocumentBase? document = null, IList<InputThemeSettingsBase>? settings = null, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<ThemeBase>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<bool>> InstallThemeAsync(bool dark = true, InputThemeBase? theme = null, string? format = null, BaseThemeBase? baseTheme = null, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<ThemesBase>> GetThemesAsync(string format, long hash, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            var rpcResponse = new RpcMessage<RpcVector<WallPaperBase>>(new RpcVector<WallPaperBase>());
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<bool>> ReportProfilePhotoAsync(InputPeerBase peer, InputPhotoBase photoId, ReportReasonBase reason, string message, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<ResetPasswordResultBase>> ResetPasswordAsync(MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<ResetPasswordResultBase>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<bool>> DeclinePasswordResetAsync(MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<ThemesBase>> GetChatThemesAsync(long hash, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<ThemesBase>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<bool>> SetAuthorizationTTLAsync(int authorizationTtlDays, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<bool>> ChangeAuthorizationSettingsAsync(long hash, bool? encryptedRequestsDisabled = null, bool? callRequestsDisabled = null, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var rpcResponse = new RpcMessage<bool>();
            messageSendingOptions ??= new MessageSendingOptions(isEncrypted: true);
        ...
        public async Task<RpcMessage<bool>> ReportPeerAsync(PeerId peer, ReportReasonBase reason, string message, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RpcMessage<bool>> ReportProfilePhotoAsync(PeerId peer, InputPhotoBase photoId, ReportReasonBase reason, string message, MessageSendingOptions? messageSendingOptions = null, CancellationToken cancellationToken = default)
        {
            var peerToResolve = _client.DatabaseManager.PeerDatabase.ResolvePeer(peer);
            if (peerToResolve is null)
            {
